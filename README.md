...
Утилита для **анализа** .exe‑файлов, собранных через **Nuitka** (а также **PyInstaller** и другие упаковщики). Извлекает метаданные, строки, модули, информацию о PE‑структуре и другую полезную информацию.
